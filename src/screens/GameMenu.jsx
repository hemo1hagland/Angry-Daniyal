...
export default function GameMenu({ onSelect, onBack, onShare, eventPack, onPremiumPreview }) {
  ...
  return (
    <main className="relative flex h-full min-h-0 flex-col items-center overflow-y-auto overscroll-contain bg-white px-6 pb-[max(3rem,env(safe-area-inset-bottom))] pt-20 text-center touch-pan-y" style={{ WebkitOverflowScrolling: "touch" }}>
      ...
      <h1 className="mb-3 font-display text-6xl font-bold tracking-tighter text-gray-900">Vors</h1>
      <p className="mb-9 max-w-xs font-body text-base text-gray-400">Velg spill og send mobilen rundt bordet.</p>
